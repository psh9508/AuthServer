...
class UserRepository:
    ...
    async def aget(self, user_id: uuid.UUID) -> User | None:
    ...
    async def alogin(self, user_id: uuid.UUID, login_id: str, password: str) -> User | None:
        user = await self.aget(user_id)
